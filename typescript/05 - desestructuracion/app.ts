...
/*    console.log(nombre);
 ...
 // const poderesHero = (hero: any ) => console.log(`Mi poder es: ${hero.poder}`);
  ...
  const poderesHero = ({ poder }: any ) => console.log(`Mi poder es: ${poder}`);

  poderesHero(hero);


  const heros: string[] = ['Superman', 'Spider-man', 'Ironman']
...
//  console.log(heroTwo);
  ...
  const whoIam = ([ ,hero]: string[]) => console.log(`Hola, Soy ${hero}`) 
